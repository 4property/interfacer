...
def basicKeyValuePath = Paths.get(basedir.toString(), 'target', 'generated-sources', 'avro', 'pl', 'matsuo', 'interfacer', 'showcase', 'BasicKeyValue.java')
...
def keyValueReferencePath = Paths.get(basedir.toString(), 'target', 'generated-sources', 'avro', 'pl', 'matsuo', 'interfacer', 'showcase', 'KeyValueReference.java')
...
assert keyValueReferenceContent.contains('implements org.apache.avro.specific.SpecificRecord, pl.matsuo.interfacer.showcase.IKeyValueProvider')
println "KeyValueReference class correctly implements IKeyValueProvider interface. This happens only on the second pass of the interfacer scan."
